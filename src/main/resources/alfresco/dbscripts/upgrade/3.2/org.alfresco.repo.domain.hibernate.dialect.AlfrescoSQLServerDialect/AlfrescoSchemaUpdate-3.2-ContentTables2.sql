...
DROP INDEX alf_content_url.idx_alf_cont_url_crc;                    --(optional)
DROP INDEX alf_content_url.idx_alf_conturl_cr;                      --(optional)
...
ALTER TABLE alf_content_url DROP COLUMN version;                    --(optional)
ALTER TABLE alf_content_url ADD orphan_time NUMERIC(19,0) NULL;     --(optional)
