...
ALTER TABLE alf_child_assoc
   ADD qname_crc NUMERIC(19,0) NOT NULL CONSTRAINT qname_crc_default DEFAULT 0;
...
ALTER TABLE alf_child_assoc DROP CONSTRAINT qname_crc_default;

DROP INDEX alf_child_assoc.idx_alf_cass_qnln;
